...
[![india](https://img.shields.io/badge/india-0.1--4-orange)](https://cran.r-project.org/package=india)
[![L1pack](https://img.shields.io/badge/L1pack-0.62--4-orange)](https://cran.r-project.org/package=L1pack)

Replication files related to the paper **On the mean-shift outlier model for LAD regression** by Felipe Osorio

Code tested on R under development (2025-02-20 r87772), running Linux Mint 22.1 (64 bits)

Attached packages: india 0.1-4, L1pack 0.62-4
