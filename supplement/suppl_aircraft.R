...
## Fig 3(a): Likelihood ratio test statistic
par(pty = "s")
...
## Fig 4(b): standardized residuals
par(pty = "s")
plot(z$std, ylab = "standardized residuals", ylim = c(-2,4), lwd = 2, cex.lab = 1.3)
abline(h = 0, lwd = 2, col = "gray75")par(pty = "s")
...
## Fig 4(c): simulated envelope based on quantile residuals
...
## Fig 4(d): simulated envelope based on 'standarized' residuals
